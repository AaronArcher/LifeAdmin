//
//  TravelFilteredAccountView.swift
//  LifeAdmin
//
...
struct TravelFilteredAccountView: View {
    ...
    @FetchRequest(sortDescriptors: [
        SortDescriptor(\.name),
    ], predicate: FilterPredicates.activeTravelPredicate) var activeAccounts: FetchedResults<AccountData>

    @FetchRequest(sortDescriptors: [
        SortDescriptor(\.name),
    ], predicate: FilterPredicates.inactiveTravelPredicate) var inactiveAccounts: FetchedResults<AccountData>
...
struct TravelFilteredAccountView_Previews: PreviewProvider {
    static var previews: some View {
        TravelFilteredAccountView(showTotalAs: .constant(""), showActive: .constant(true), showDelete: .constant(false), selectedID: .constant(UUID()), totalPrice: .constant(0), showTabBar: .constant(false))
    }
}
