//
//  FinanceFilteredAccountView.swift
//  LifeAdmin
//
...
struct FinanceFilteredAccountView: View {
    ...
    @FetchRequest(sortDescriptors: [
        SortDescriptor(\.name),
    ], predicate: FilterPredicates.activeFinancePredicate) var activeAccounts: FetchedResults<AccountData>

    @FetchRequest(sortDescriptors: [
        SortDescriptor(\.name),
    ], predicate: FilterPredicates.inactiveFinancePredicate) var inactiveAccounts: FetchedResults<AccountData>
...
struct FinanceFilteredAccountView_Previews: PreviewProvider {
    static var previews: some View {
        FinanceFilteredAccountView(showTotalAs: .constant(""), showActive: .constant(true), showDelete: .constant(false), selectedID: .constant(UUID()), totalPrice: .constant(0), showTabBar: .constant(false))
    }
}
