//
//  SocialMediaFilteredAccountView.swift
//  LifeAdmin
//
...
struct SocialMediaFilteredAccountView: View {
    ...
    @FetchRequest(sortDescriptors: [
        SortDescriptor(\.name),
    ], predicate: FilterPredicates.activeSocialMediaPredicate) var activeAccounts: FetchedResults<AccountData>

    @FetchRequest(sortDescriptors: [
        SortDescriptor(\.name),
    ], predicate: FilterPredicates.inactiveSocialMediaPredicate) var inactiveAccounts: FetchedResults<AccountData>
...
struct SocialMediaFilteredAccountView_Previews: PreviewProvider {
    static var previews: some View {
        SocialMediaFilteredAccountView(showTotalAs: .constant(""), showActive: .constant(true), showDelete: .constant(false), selectedID: .constant(UUID()), totalPrice: .constant(0), showTabBar: .constant(false))
    }
}
