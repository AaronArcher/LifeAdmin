//
//  HealthFilteredAccountView.swift
//  LifeAdmin
//
//  Created by Aaron Johncock on 18/04/2022.
//

import SwiftUI

struct HealthFilteredAccountView: View {
    ...
    @FetchRequest(sortDescriptors: [
        SortDescriptor(\.name),
    ], predicate: FilterPredicates.activeHealthPredicate) var activeAccounts: FetchedResults<AccountData>

    @FetchRequest(sortDescriptors: [
        SortDescriptor(\.name),
    ], predicate: FilterPredicates.inactiveHealthPredicate) var inactiveAccounts: FetchedResults<AccountData>
...
struct HealthFilteredAccountView_Previews: PreviewProvider {
    static var previews: some View {
        HealthFilteredAccountView(showTotalAs: .constant(""), showActive: .constant(true), showDelete: .constant(false), selectedID: .constant(UUID()), totalPrice: .constant(0), showTabBar: .constant(false))
    }
}
